...
var (
	authMapFile    = flag.String("auth-file", "virtualize-monitor.yaml", "file containing the authentication map to use when connecting to a Spectrum Virtualize device")
