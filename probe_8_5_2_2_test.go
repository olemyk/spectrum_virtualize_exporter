...
// Section for 8.5.2.2 on flashsystem
...
func TestNodeStats(t *testing.T) {
	...
	spectrum_node_fc_iops{id="1"} 1935
	spectrum_node_fc_iops{id="2"} 1962
	...
	spectrum_node_system_usage_ratio{id="1"} 0.06
	spectrum_node_system_usage_ratio{id="2"} 0.05
	...
	spectrum_node_vdisk_read_iops{id="2"} 0
	...
	spectrum_node_write_cache_usage_ratio{id="1"} 0
	spectrum_node_write_cache_usage_ratio{id="2"} 0
	`
